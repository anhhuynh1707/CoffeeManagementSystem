...
<body>
	...
	<div class="navbar">
		...
		<div class="weather-box" id="weatherBox">
			<span class="weather-icon" id="weatherIcon">⛅</span> <span class="weather-text"
				id="weatherText">Loading...</span> <span class="separator">|</span> <span class="weather-greet"> How
				do you feel today, <strong>
					<c:choose>
	...
	<div class="filter-bar">
		...
		<form id="categoryForm" action="${pageContext.request.contextPath}/menu" method="get">
			...
			<input type="hidden" name="sort" id="categorySortInput" value="${param.sort}">
		...
		<!-- SEARCH + SORT FORM -->
		<form action="${pageContext.request.contextPath}/menu" method="get" class="search-sort-form">

			<!-- preserve category -->
			<input type="hidden" name="category" value="${param.category != null ? param.category : 'all'}">

			<!-- search -->
			<input type="text" name="q" placeholder="Search menu..." value="${param.q}">
	...
	<div class="menu-grid">
		<c:forEach var="item" items="${menuList}">
			<div class="item-card">
				...
				<h3>${item.name}</h3>
				<div class="price">
					<fmt:formatNumber value="${item.price}" groupingUsed="true" maxFractionDigits="0" /> VND
				</div>

				<form action="${pageContext.request.contextPath}/cart" method="get">
					<input type="hidden" name="op" value="add"> <input type="hidden" name="pid" value="${item.id}">
