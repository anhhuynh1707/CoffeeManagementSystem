	  ...
	  <div class="card" style="overflow:hidden;">
	    ...
	    <table>
	      <tr>
	        ...
	        <th style="width: 90px;">
	        <a href="products?page=${page}&q=${param.q}&category=${param.category}&status=${param.status}&sortBy=id&sortDir=${sortBy == 'id' ? nextDir : 'asc'}"
	        style="color:white; text-decoration:none;">ID
	        <c:if test="${sortBy == 'id'}">
	        ${sortDir == 'asc' ? '↑' : '↓'}
	        </c:if></a>
	        </th>
	        ...
	        <tr>
	          ...
	          <td>
	            <div class="row-actions">
	              ...
	              <a class="btn btn-warning" href="products?op=toggle&id=${p.id}&page=${page}&q=${param.q}&category=${param.category}&status=${param.status}&sortBy=${sortBy}&sortDir=${sortDir}">
	    ...
	    <div class="muted"> Page <b>${page}</b> of <b>${totalPages}</b> — Total products: <b>${totalItems}</b></div>
	      ...
	      <form action="products" method="post" enctype="multipart/form-data">
	        ...
	        <div class="form-grid">
	          <div class="field">
	            ...
	            <input class="input" type="text" name="name" placeholder="e.g. Matcha Espresso Fusion">
	          </div>
	          ...
	          <div class="field">
	            <label>Price ($)</label>
	            <input class="input" type="number" step="0.01" name="price" placeholder="e.g. 5.50">
	          </div>
	          ...
	          <div class="field full">
	            ...
	            <textarea class="input" name="description" placeholder="Short product description..."></textarea>
	          </div>
